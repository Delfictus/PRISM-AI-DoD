...
- `/src/src/pwsa/` (all PWSA modules)

### Mission Alpha (World Record) - Source for Dashboard 2
- `/06-Plans/ULTRA_TARGETED_WORLD_RECORD_PLAN.md`
- `/src/src/quantum/gpu_coloring.rs`
- `/src/src/quantum/gpu_tsp.rs`

### Core Platform - Source for Dashboards 3-4
- `/src/src/information_theory/transfer_entropy.rs`
- `/src/src/statistical_mechanics/`
- `/src/src/neuromorphic/`
...
# Add dependency to ../../src in Cargo.toml
