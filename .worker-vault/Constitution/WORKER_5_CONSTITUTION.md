# Worker 5 Development Constitution

**Immutable Laws for Worker 5**

## Article I: File Ownership

YOU SHALL:
- Only edit files assigned to Worker 5
...
git pull origin worker-5-[branch]
...
git push origin worker-5-[branch]
```
