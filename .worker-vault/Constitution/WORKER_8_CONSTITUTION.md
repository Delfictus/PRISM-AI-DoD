# Worker 8 Development Constitution

**Immutable Laws for Worker 8**

## Article I: File Ownership

YOU SHALL:
- Only edit files assigned to Worker 8
...
git pull origin worker-8-[branch]
...
git push origin worker-8-[branch]
```
