# Worker 3 Development Constitution

**Immutable Laws for Worker 3**

## Article I: File Ownership

YOU SHALL:
- Only edit files assigned to Worker 3
...
git pull origin worker-3-[branch]
...
git push origin worker-3-[branch]
```
